  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <article className="mx-auto max-w-3xl p-6 gap-6 py-12 space-y-8">
        ...
        <h1 className="text-4xl font-[family-name:var(--font-display)]">{String(row.name ?? 'Ingredient')}</h1>
        ...
        <Link to="/ingredients/"><Button variant="outline" className="transition-all duration-200">Back to Ingredients</Button></Link>
      </article>
    </div>
  )
}
